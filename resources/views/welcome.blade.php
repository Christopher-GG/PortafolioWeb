                ...
                <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a class="text-gray-900 dark:text-white">¿Quién soy?</a></div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Soy Christopher Gómez García, un estudiante de la carrera de Ingeniería en Sistemas Computacionales en el Tecnológico Mario Molina Lagos de Moreno, Jalisco; en el cual estoy cursando octavo semestre. Actualmente tengo 26 años y he trabajado en variedad de proyectos dentro de la escuela desde programación web hasta administración de redes, así mismo cuento con experiencia en el área de atención al cliente dentro de la empresa Xcaret.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Me gustan los juegos de mesa, principalmente los de destreza mental y estrategia, también los videojuegos en un rango variado de géneros desde aventura hasta shooters; además me gustan los deportes, principalmente voleibol y Taekwondo, este último siendo que más practico.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a class="text-gray-900 dark:text-white">¿En qué me enfoco?</a></div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Me enfoco principalmente al maquetado de páginas, programación en C++, Creación y administración de bases de datos, arquitectura de computadoras y administración de redes.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                        <div class="grid grid-cols-1 md:grid-cols-2">
                            <div class="p-6">
                                ...
                                <div class="ml-12">
                                    <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                        Durante sexto semestre de la carrera, junto a dos compañeros, hicimos una autolavado automatico, el cual funcionaba mediante sensores (de agua y precensia) para llevar un control de la catidad de agua y la estación donde se encontraba el vehiculo, así mismo contaba con una banda transportadora la cual llevaba el vehiculo por las estaciones. Ademas se contaba con un software donde se puede llevar un control del tiempo y la estación en la que se encuentra para mayor comodidad el usuario.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                                ...
                                <div class="ml-12">
                                    <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                        Junto a cuatro compañeros realizamos un proyecto de un punto de venta para un restaurante de tacos, el cual incluia desde la visualizacion del menu hasta el control de inventario, permitiendo de esta manera poder tener un control total del negocio, pues incluia el control de horario de los trabajadores.
                                    </div>
                                </div>
                            </div>
